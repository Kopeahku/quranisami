;window.CloudflareApps=window.Eager=window.CloudflareApps||window.Eager||{};window.CloudflareApps=window.CloudflareApps||{};CloudflareApps.siteId="52b6dd21a186f49ba0ef53c88841387e";CloudflareApps.installs=CloudflareApps.installs||{};;(function(){'use strict'
...
return false}}());CloudflareApps.installs["HJxX2NYRjpYu"]={appId:"lMxPPXVOqmoE",scope:{}};;CloudflareApps.installs["HJxX2NYRjpYu"].options={"id":"UA-99072547-1","social":true};;if(CloudflareApps.matchPage(CloudflareApps.installs['HJxX2NYRjpYu'].URLPatterns)){(function(){var options=CloudflareApps.installs['HJxX2NYRjpYu'].options
var id
...
return}else if("HJxX2NYRjpYu"==='preview'){console.log('Cloudflare Google Analytics: Enabled',id)}
